<table>
    <tr>
        <th width="30%" class="metabox_label_column">
            <label for="program_description"> <?php echo __('Short Description'); ?></label>
        </th>
        <td>
    ...
    <tr>
        <th class="metabox_label_column">
            <label for="program_is_active"> <?php echo __('Details Link'); ?></label>
        </th>
        <td>
            <input id="program_details_link" name="program_details_link" type="text" value="<?php echo @get_post_meta($post->ID, 'program_details_link', true); ?>"/>
        </td>
    </tr>
    <tr>
        <th class="metabox_label_column">
            <label for="program_is_active"> <?php echo __('Is Active'); ?></label>
        </th>
        <td>
